...
export default function SysDashboard() {
  ...
  useEffect(() => {
    ...
    const token = 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJzeXNhZG1pbkBleGFtcGxlLmNvbSIsImlhdCI6MTcxNDkxNjIyNywiZXhwIjoxNzE1MDAyNjI3fQ.d96Euco4Z4kCUB3qxJzQQHelJs0ScU2enPeek7ToOpw';
    fetch(urlOrganismes, {
      method: 'GET',
      headers: {
